...
const SignUp = (props) => {
  ...
  const authHandler = useCallback(async () => {
    ...
    try {
      ...
      setIsLoading(false);
      if (err) {
        Alert.alert(`Error ocurred during registration`, `${err}`, [{ text: "OK" }]);
      }
    }
  }, [formState]);
        ...
        <Card style={styles.authContainer}>
          <ScrollView>
            ...
            <View style={styles.buttonContainer}>
              <Button title="Register" disabled={!formState.formIsValid} color={colors.blueish} onPress={authHandler} />
            </View>
            <View style={styles.buttonContainer}>
              <Button
